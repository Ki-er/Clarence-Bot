...
module.exports = {
	data: new SlashCommandBuilder()
	  ...
	  .addStringOption(option => option.setName('link').setDescription('The destination URL you want your branded short link to point to').setRequired(true)),
      async execute(interaction) {
        ...
        try {
            ...
            await interaction.editReply(`Here's your shortened link: ${shortenedLink}`);
          } catch (error) {
            console.error(error);
