...
client.on('interactionCreate', async (interaction) => {
	...
	if (interaction.isSelectMenu()) {
		if (interaction.customId == 'help') {
			if (interaction.values.includes('fun')) {
				...
				const embed = new discord.MessageEmbed()
					...
					.addField(
						'-channelinfo',
						'Displays information about a certain channel'
					)
					.addField('-userinfo', 'Displays information about a certain user');
			} else if (
				interaction.values.includes('admin') &&
				...
				await interaction.update({
					content: 'You do not have permission to view these commands.',
					ephemeral: true,
				});
			}
		}
		...
		if (interaction.customId == 'pingables') {
			if (interaction.values.includes('smallUpdates'))
				interaction.member.roles.add('877156174364020736');
			else interaction.member.roles.remove('877156174364020736');

			if (interaction.values.includes('clarenceUpdates'))
				interaction.member.roles.add('877156320569081856');
			else interaction.member.roles.remove('877156320569081856');

			if (interaction.values.includes('randomUpdates'))
				interaction.member.roles.add('784158568675934267');
			else interaction.member.roles.remove('784158568675934267');

			if (interaction.values.includes('allUpdates'))
				interaction.member.roles.add('886532503249244191');
		...
		if (interaction.customId == 'games') {
			if (interaction.values.includes('R6'))
				interaction.member.roles.add('805540203132878869');
			else interaction.member.roles.remove('805540203132878869');

			if (interaction.values.includes('gameMineCraft'))
				interaction.member.roles.add('856086822030802944');
		...
		if (interaction.customId == 'pronouns') {
			if (interaction.values.includes('He'))
				interaction.member.roles.add('881435375816540172');
			else interaction.member.roles.remove('881435375816540172');

			if (interaction.values.includes('She'))
				interaction.member.roles.add('881435424977985546');
			else interaction.member.roles.remove('881435424977985546');

			if (interaction.values.includes('They'))
				interaction.member.roles.add('881435451448246272');
			else interaction.member.roles.remove('881435451448246272');

			if (interaction.values.includes('Any'))
				interaction.member.roles.add('881435646487564329');
			else interaction.member.roles.remove('881435646487564329');

			if (interaction.values.includes('Ask'))
				interaction.member.roles.add('881435656503574540');
		...
		if (interaction.customId == 'age') {
			if (interaction.values.includes('13'))
				interaction.member.roles.add('881438022116212767');
			else interaction.member.roles.remove('881438022116212767');

			if (interaction.values.includes('17'))
				interaction.member.roles.add('881438516339412992');
			else interaction.member.roles.remove('881438516339412992');

			if (interaction.values.includes('21'))
				interaction.member.roles.add('881438520063959040');
			else interaction.member.roles.remove('881438520063959040');

			if (interaction.values.includes('25'))
				interaction.member.roles.add('881438522794446848');
			else interaction.member.roles.remove('881438522794446848');

			if (interaction.values.includes('28'))
				interaction.member.roles.add('881438525021634560');
			else interaction.member.roles.remove('881438525021634560');

			if (interaction.values.includes('30'))
				interaction.member.roles.add('881438528364511252');
